...
<body>
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <div class="col-md-4">
                <asp:Button ID="btnsignup" runat="server" CssClass="btn btn-danger"  Text="Signup" />
                <asp:Button ID="btnlogin" runat="server" CssClass="btn btn-danger" Text="Login" />
            </div>
        </div>--%>
            <div class="row" style="background-image: url(img/d.jpg); height: 610px; background-size: 100% 610px; background-repeat:no-repeat">
                <div class="col-md-8">
   

                </div>
                <div class="registerform col-md-4" style="">
