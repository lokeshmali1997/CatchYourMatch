...
namespace ImagerLib
{
    public static class Imager
    {
        ...
        public static String PerformImageResizeAndPutOnCanvas(string pFilePath, string pFileName, int pWidth, int pHeight)
        {
            ...
            //Save JPEG  
            Imager.SaveJpeg("D:/study/sem6 project/CatchYourMatch/ProfileImage/" + pFileName, _img2);
